...
**Target keyword:** AI automation vs AI implementation
...
2. Sends a personalised welcome email via Klaviyo
3. Notifies the sales rep in Slack
4. Creates a follow-up task in your project management tool

This is automation. It connects tools that already exist, follows a defined trigger-action logic, and can be built in days to weeks.

**When automation is the right answer:** You have a defined, multi-step workflow that connects existing tools. The logic is clear and doesn't require AI decision-making. Budget: typically AUD $2,000–$20,000.

**Limitations of automation:** It can only follow the rules you define. It can't handle unstructured inputs (like reading a customer email and understanding what they want). It can't make decisions that require judgement. It doesn't get smarter over time.

---

## AI implementation: custom systems that understand, decide, and act
...
5. Learns from feedback to improve accuracy over time

This is implementation. It requires custom development, training data, integration work, and ongoing optimisation. Budget: typically AUD $30,000–$150,000+.

**When implementation is the right answer:** You have a problem that involves unstructured data (text, documents, audio), decisions that can't be encoded as simple rules, or a need for the system to improve over time.

---

## How to tell which one you need

Ask yourself: can I write down a complete set of rules that would let a non-AI system solve this problem?
...
- Move a deal to the next CRM stage when a meeting is logged
- Send a notification when an invoice is overdue by 7 days

Examples of implementation problems:
- Classify customer support tickets by intent and resolve tier-1 queries
- Extract data from unstructured supplier invoices
- Identify which customers are at risk of churning before they cancel
- Generate personalised product recommendations

---

## Why the distinction matters for how you shop

Automation agencies and AI implementation agencies aren't the same market.
