...
export const phases = [
  {
    ...
    guarantee: "We'll find you five hours a week, or you don't pay.",
    priceNote: [
      "If the assessment doesn't identify at least five hours a week we can give you back, you get all $2,000 returned. The recommendations are in writing, so you can see exactly what you're getting before you spend a cent on tools.",
    ],
    deliverables: [
