...
const contentSecurityPolicy = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://connect.facebook.net https://capi-automation.s3.us-east-2.amazonaws.com https://www.google-analytics.com https://*.google-analytics.com https://googleads.g.doubleclick.net https://www.googleadservices.com https://*.posthog.com https://news.google.com",
  ...
  "frame-src https://www.googletagmanager.com https://www.facebook.com https://*.doubleclick.net https://news.google.com",
      ...
      beforeFiles: [
        {
          ...
          has: [
            {
              type: "host",
              value: "websites.creative-milk.com.au",
            },
          ],
